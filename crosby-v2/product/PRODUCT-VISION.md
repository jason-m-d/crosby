...
**Copied into v2 planning folder: 2026-03-25**

> **Note:** This is the original product vision doc from the project root, copied here so all v2 planning material lives in one place. The canonical version for v1 remains at `/CROSBY-PRODUCT-VISION.md`. Some details here have been superseded by the detailed product specs in `product/` — when in conflict, the individual product specs are authoritative.
