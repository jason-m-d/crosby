          ...
          <form onSubmit={handleChangePassword} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-transparent border border-border px-3 py-2 text-[0.8125rem] outline-none focus:border-foreground/30 transition-colors"
              />
            </div>
            <div className="space-y-1.5">
              <label className="text-[0.625rem] uppercase tracking-[0.15em] text-muted-foreground/50 font-medium">
            ...
            {success && (
              <p className="text-[0.75rem] text-green-600 flex items-center gap-1.5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="inline-flex items-center gap-1.5 px-4 py-2 text-[0.75rem] bg-foreground text-background disabled:opacity-30 transition-opacity"
            >
